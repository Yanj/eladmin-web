...
export default {
  ...
  methods: {
    ...
    loadData() {
      this.loading = true
      userWorkCountApi.getUserWorkCountGroup(this.query).then(res => {
        if (res) {
          this.tableColumns = res.resourceGroups
    ...
    handleDownload() {
      ...
      download('api/yy/userWorkCount/downloadCountGroup', this.query).then(result => {
