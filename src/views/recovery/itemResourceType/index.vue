  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="resourceType.name" label="资源类型" />
        <el-table-column v-permission="['admin','rcvItemResourceType:edit','rcvItemResourceType:del']" label="操作" width="150px" align="center">
...
<script>
import crudRcvItemResourceType from '@/api/recovery/rcvItemResourceType'
...
export default {
  name: 'RcvItemResourceType',
  components: { Treeselect, pagination, crudOperation, udOperation },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  cruds() {
    return CRUD({ title: '套餐资源类型', url: 'api/recovery/rcvItemResourceType', idField: 'id', sort: 'id,desc', crudMethod: { ...crudRcvItemResourceType }})
  },
  data() {
    return {
      permission: {
        add: ['admin', 'rcvItemResourceType:add'],
        edit: ['admin', 'rcvItemResourceType:edit'],
        del: ['admin', 'rcvItemResourceType:del']
      },
      rules: {
        id: [
