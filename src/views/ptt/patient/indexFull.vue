      ...
      <el-col :xs="24" :sm="24" :md="10" :lg="11" :xl="11" style="margin-bottom: 10px">
        <el-card class="box-card">
          ...
          >
            ...
            <el-table-column label="所属医院" prop="deptName" />
...
import indexCols from './indexCols'
...
export default {
  name: 'Patient',
  components: { crudOperation, rrOperation, udOperation, indexCols },
  cruds() {
    return CRUD({
      title: '患者管理',
      url: 'api/ptt/patient/full',
      crudMethod: { ...crudApi },
      sort: ['deptId,asc']
    })
  },
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      if (val) {
        this.$refs.indexCols.query.deptId = val.deptId
        this.$refs.indexCols.query.patientId = val.patientId
        this.$refs.indexCols.crud.toQuery()
      }
    }
  }
}
